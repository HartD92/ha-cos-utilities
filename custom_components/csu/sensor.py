...
async def async_setup_entry(hass: HomeAssistant, config_entry, async_add_entities):
    ...
    coordinator.api.customers = await coordinator.api.async_get_customers()
    coordinator.api.meters = await coordinator.api.async_get_meters()
    # 
    async_add_entities(
